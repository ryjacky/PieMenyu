...
class _PieMenuPropertiesState extends State<PieMenuProperties> {
  ...
  Widget build(BuildContext context) {
    final pieItems =
        context.select<PieMenuState, Set<PieItem>>((value) => value.pieItems);
                                  ...
                                  children: [
                                    ...
                                    ExpansionColorPickerTile(
                                      ...
                                      onColorChanged: (color) {
                                        context
                                            .read<PieMenuState>()
                                            .updatePieMenu(pieMenu
                                              ..mainColor = color.value);
                                      },
                                    ),
                                    ExpansionColorPickerTile(
                                      title:
                                          Text("label-secondary-color".i18n()),
